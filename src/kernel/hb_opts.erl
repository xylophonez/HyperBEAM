...
raw_default_message() ->
    #{
        ...
        %% Filesystem store containing the signed specifications,
        %% implementations, and Device-Index for the devices baked into
        %% the build. Generated by `rebar3 device preload' before the
        %% kernel boots — see `hb_preload'.
        <<"preloaded-store">> =>
            #{
                <<"store-module">> => hb_store_fs,
